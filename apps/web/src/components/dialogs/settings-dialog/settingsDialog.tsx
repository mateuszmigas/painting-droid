...
export const SettingsDialog = memo((props: { initialTab?: SettingsTab; close: () => void }) => {
  const { initialTab } = props;
  const [selectedTab, setSelectedTab] = useState<SettingsTab>(initialTab ?? "general");
        ...
        >
          <div className="w-full flex justify-start pb-medium">
            <TabsList className="justify-start">
              <TabsTrigger value="general">{dialogTranslations.tabs.general.title}</TabsTrigger>
              <TabsTrigger value="models">{dialogTranslations.tabs.models.title}</TabsTrigger>
            </TabsList>
          </div>
